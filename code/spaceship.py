"""
This moudle provides a Spaceship object, which is controlled by Player.
"""
...
class Spaceship(Sprite):
    ...
    def __init__(self, ai_game, resized: bool = False) -> None:
        ...
        # Position is represented as a float - more accurate tracking.
    ...
    def update(self, *args, **kwargs) -> None:
        ...
        if self.moving_left and self.rect.left > 0:  # Usage of elif - priority for moving right.
            self.x -= self.settings.player_ship_speed
